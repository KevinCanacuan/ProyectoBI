...
belgica=vistas('http://127.0.0.1:5984/belgicafinal/_design/belgicaporPais14JulioMundial/_view/belgicaporPais14JulioMundial')
inglaterra=vistas('http://127.0.0.1:5984/inglaterrafinal/_design/inglaterraporPais14JulioMundial/_view/inglaterraporPais14JulioMundial')
russia=vistas('http://127.0.0.1:5984/rusiafinal/_design/rusiaporPais14JulioMundial/_view/rusiaporPais14JulioMundial')
...
hashtags={"World":"WORLDCUP","World2018":"WORLDCUP18","Rusia2018":"RUSIA2018","Ingla": "ENG","Russia":"RUS","Belgica":"BEL"}
...
for q in range(len(listaText)):
	...
	if hashtags["World"] in textoLimpio or hashtags["World2018"] in textoLimpio or hashtags["Rusia2018"] in textoLimpio or hashtags["Belgica"] in textoLimpio or hashtags["Ingla"] in textoLimpio or hashtags["Russia"] in textoLimpio:
...
plt.title('Tweets por paises Inglaterra-Belgica (14 de Julio)')
plt.show()
