...
croacia=vistas('http://127.0.0.1:5984/croaciafinal/_design/croaciaporPais15JulioMundial/_view/croaciaporPais15JulioMundial')
francia=vistas('http://127.0.0.1:5984/franciafinal/_design/franciaporPais15JulioMundial/_view/franciaporPais15JulioMundial')
russia=vistas('http://127.0.0.1:5984/rusiafinal/_design/rusiaporPais15JulioMundial/_view/rusiaporPais15JulioMundial')
...
hashtags={"World":"WORLDCUP","World2018":"WORLDCUP18","Rusia2018":"RUSIA2018","Croacia":"CRO","Russia":"RUS","Francia":"FRA"}
...
for q in range(len(listaText)):
	...
	if hashtags["World"] in textoLimpio or hashtags["World2018"] in textoLimpio or hashtags["Rusia2018"] in textoLimpio or hashtags["Croacia"] in textoLimpio or hashtags["Russia"] in textoLimpio or hashtags["Francia"] in textoLimpio:
...
plt.title('Tweets por paises Francia-Croacia (15 de Julio)')
plt.show()
