...
russia=vistas('http://127.0.0.1:5984/rusiafinal/_design/rusiaSentimientos15/_view/rusiaSentimientos15')
croacia=vistas('http://127.0.0.1:5984/croaciafinal/_design/croaciaSentimientos15/_view/croaciaSentimientos15')
francia=vistas('http://127.0.0.1:5984/franciafinal/_design/franciaSentimientos15/_view/franciaSentimientos15')
...
hashtags={"World":"WORLDCUP","World2018":"WORLDCUP18","Rusia2018":"RUSIA2018","Rusia":"RUS","Francia":"FRA","Croacia": "CRO"}
...
for x in range(len(listaText)):
	...
	if hashtags["World"] in textoLimpio or hashtags["World2018"] in textoLimpio or hashtags["Rusia2018"] in textoLimpio or hashtags 	["Rusia"] in textoLimpio or hashtags["Francia"] in textoLimpio or hashtags["Croacia"] in textoLimpio:
...
plt.title('Analisis Sentimientos Francia vs Croacia')
plt.axis('equal')
plt.show()
