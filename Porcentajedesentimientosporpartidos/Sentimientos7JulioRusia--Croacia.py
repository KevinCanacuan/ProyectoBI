...
for x in range(len(listaText)):
	...
	if hashtags["World"] in textoLimpio or hashtags["World2018"] in textoLimpio or hashtags["Rusia2018"] in textoLimpio or hashtags	   		["Rusia"]  in textoLimpio or hashtags["Croacia"]:
...
plt.title('Analisis Sentimientos Rusia vs Croacia')
plt.axis('equal')
plt.show()
