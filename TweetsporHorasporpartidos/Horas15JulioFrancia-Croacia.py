...
for q in range(len(listaText)):
	...
	if hashtags["World"] in textoLimpio or hashtags["World2018"] in textoLimpio or hashtags["Rusia2018"] in textoLimpio or hashtags      ["Rusia"] in textoLimpio or hashtags["Croacia"] in textoLimpio or hashtags["Francia"] in textoLimpio:
...
plt.title('Tweets por hora Francia-Croacia 15 de Julio')
plt.show()
