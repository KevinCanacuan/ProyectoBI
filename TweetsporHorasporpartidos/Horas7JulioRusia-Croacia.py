...
croacia=vistas('http://127.0.0.1:5984/croaciafinal/_design/croaciaSentimientos7/_view/croaciaSentimientos7')
...
hashtags={"World":"WORLDCUP","World2018":"WORLDCUP18","Rusia2018":"RUSIA2018","Rusia":"RUS","Croacia": "CRO"}
...
for q in range(len(listaText)):
	...
	if hashtags["World"] in textoLimpio or hashtags["World2018"] in textoLimpio or hashtags["Rusia2018"] in textoLimpio or hashtags      ["Rusia"] in textoLimpio or hashtags["Croacia"] in textoLimpio:
		if "07" in listaHora[q]:
			...
			contadorhoras[1]=contadorhoras[10]+1
...
plt.title('Tweets por hora (Russia-Croacia 7 de Julio)')
plt.show()
