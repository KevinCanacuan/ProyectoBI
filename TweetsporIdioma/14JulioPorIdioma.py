...
inglaterra=vistas('http://127.0.0.1:5984/inglaterrafinal/_design/inglaterraporIdioma14Julio/_view/inglaterraporIdioma14Julio')
belgica=vistas('http://127.0.0.1:5984/belgicafinal/_design/belgicaporIdioma14Julio/_view/belgicaporIdioma14Julio')
rusia=vistas('http://127.0.0.1:5984/rusiafinal/_design/rusiaporIdioma14Julio/_view/rusiaporIdioma14Julio')
...
plt.title('Tweets por Idiomas InglaterravsBelgica (14 de Julio)')
plt.show()
