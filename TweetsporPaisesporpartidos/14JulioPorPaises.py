...
inglaterra=vistas('http://127.0.0.1:5984/inglaterrafinal/_design/inglaterraporPais15Julio/_view/inglaterraporPais15Julio')
belgica=vistas('http://127.0.0.1:5984/belgicafinal/_design/belgicaporPais14Julio/_view/belgicaporPais14Julio')
russia=vistas('http://127.0.0.1:5984/rusiafinal/_design/rusiaporPais14Julio/_view/rusiaporPais14Julio')
...
plt.title('Tweets por paises InglaterravsBelgica (14 de Julio)')
plt.show()
