...
francia=vistas('http://127.0.0.1:5984/franciafinal/_design/franciaporPais15Julio/_view/franciaporPais15Julio')
croacia=vistas('http://127.0.0.1:5984/croaciafinal/_design/croaciaporPais15Julio/_view/croaciaporPais15Julio')
russia=vistas('http://127.0.0.1:5984/rusiafinal/_design/rusiaporPais15Julio/_view/rusiaporPais15Julio')
...
plt.title('Tweets por paises FranciavsCroacia (15 de Julio)')
plt.show()
